...
StudentsTTest::StudentsTTest(const PropertyList &propList)
{
...
std::string StudentsTTest::toString() const
{
    return tfm::format(
            "StudentsTTest[\n"
            "  significanceLevel = %f,\n"
...
NoriObject::EClassType StudentsTTest::getClassType() const { return ETest; }

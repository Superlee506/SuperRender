 ...
 */
ChiSquareTest::ChiSquareTest(const PropertyList &propList)
{
...
std::string ChiSquareTest::toString() const
{
...
NoriObject::EClassType ChiSquareTest::getClassType() const { return ETest; }

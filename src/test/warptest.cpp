...
WarpTestScreen::WarpTestScreen(): Screen(Vector2i(800, 600), "warptest: Sampling and Warping"), m_bRec(nori::Vector3f()) {
    inc_ref();
    m_drawHistogram = false;
    initializeGUI();
}

float WarpTestScreen::mapParameter(WarpType warpType, float parameterValue) {
...
bool WarpTestScreen::mouse_motion_event(const Vector2i &p, const Vector2i &rel,
...
bool WarpTestScreen::mouse_button_event(const Vector2i &p, int button, bool down, int modifiers) {
...
void WarpTestScreen::draw_contents() {
...
void WarpTestScreen::drawHistogram(const nanogui::Vector2i &pos_, const nanogui::Vector2i &size_, Texture *texture) {
...
void WarpTestScreen::initializeGUI() {
